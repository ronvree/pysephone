...
``temperature_2m_mean`` and ``daylight_duration`` concatenated → ``(2 × T,)``
per sample.  A ``RandomForestRegressor`` is fitted on this representation to
predict the within-season day index of the phenological event.
